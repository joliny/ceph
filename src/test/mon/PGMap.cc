...
TEST(pgmap, min_last_epoch_clean)
{
  ...
  ASSERT_EQ(123, pg_map.get_min_last_epoch_clean());
  ...
  pg_map.apply_incremental(g_ceph_context, inc);
  ASSERT_EQ(222, pg_map.get_min_last_epoch_clean());
  ...
  pg_map.apply_incremental(g_ceph_context, inc);
  ASSERT_EQ(333, pg_map.get_min_last_epoch_clean());
  ...
  inc.pg_stat_updates[pg_t(1,1)] = ps;
  pg_map.apply_incremental(g_ceph_context, inc);
  ASSERT_EQ(223, pg_map.get_min_last_epoch_clean());
  ...
  inc.pg_stat_updates[pg_t(1,1)] = ps;
  pg_map.apply_incremental(g_ceph_context, inc);
  ASSERT_EQ(224, pg_map.get_min_last_epoch_clean());
